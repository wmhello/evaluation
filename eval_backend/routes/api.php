...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin'], function(){
    ...
    Route::post('test', 'TestController@test')->name('admin.test');
...
Route::middleware(['auth:admin'])->prefix('admin')->namespace('Admin')->group(function(){
    Route::get("/common/get_content", "CommonController@getContent")->name("common.get_content");
    Route::get("/common/get_person", "CommonController@getperson")->name("common.get_person");
    Route::get("/common/get_mark", "CommonController@getMark")->name("common.get_mark");
    Route::get("/common/get_group", "CommonController@getGroup")->name("common.get_group");
    Route::get("/grade_base_tables/get_content", "GradeBaseTableController@getContent")->name("grade_base_tables.get_content");
});

Route::middleware(['auth:admin','role'])->prefix('admin')->namespace('Admin')->group(function(){
    Route::apiResource('grade_base_tables', 'GradeBaseTableController');
});
Route::middleware(['auth:admin','role'])->prefix('admin')->namespace('Admin')->group(function(){
    Route::apiResource('grade_analysis_tables', 'GradeAnalysisTableController');
  });Route::middleware(['auth:admin','role'])->prefix('admin')->namespace('Admin')->group(function(){
