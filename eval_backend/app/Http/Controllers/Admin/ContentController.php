...
{
    use Tool;
    protected  $model = 'App\Models\Content';  // 当前模型
    protected  $fillable = [];  // 当前模型可以修改和新增的字段
    protected  $resource = 'App\Http\Resources\Content'; // 显示个体资源
    protected  $resourceCollection = 'App\Http\Resources\ContentCollection'; // 显示资源集合
